<html>
    <head>
        ...
        <link href="<?php echo asset('css/template.css'); ?>" rel="stylesheet" type="text/css"/>
    </head>
...
<nav class="navbar navbar-toggleable-md navbar-light">
  ...
  <a class="navbar-brand" href="#"><img src="<?php echo asset('images/logo-icon.png'); ?>"><div class="navbar-brand-text">Startup</div></a>
...
<!-- Scripts -->
        ...
        <script type="text/javascript" src="<?php echo asset('js/validation.js'); ?>"></script>
<script>
